...
public class NewUserHome extends AppCompatActivity
   ...
   private ProductViewAdapter adapter;
    ...
    DatabaseReference fb= FirebaseDatabase.getInstance().getReference().child("Item");
    ...
    public void onStart() {
        ...
        fb.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(NewUserHome.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.action_notification:
                Intent intent=new Intent(NewUserHome.this,ViewNotification.class);
                intent.putExtra("Pid","");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_orders) {
            ...
            Intent intent = new Intent(NewUserHome.this, NewUserCategorized.class);
            ...
            Intent intent=new Intent(NewUserHome.this,ContactUs.class);
            startActivity(intent);
        ...
        switch (item.getItemId()){
            case R.id.nav_cart:
                ...
                break;
            case R.id.nav_home:
                Intent intent1=new Intent(NewUserHome.this,NewUserHome.class);
                startActivity(intent1);
                break;
            case R.id.nav_login:
                Intent intent2=new Intent(NewUserHome.this,LoginActivity.class);
    ...
    public void onBackPressed() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(NewUserHome.this);
