        ...
        OtherRef.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if(dataSnapshot.exists()) {
                ...
                number1=dataSnapshot.child("ophone").getValue().toString();
                email=dataSnapshot.child("oemail").getValue().toString();
                adminPhone.setText(dataSnapshot.child("ophone").getValue().toString());
                adminMAil.setText(dataSnapshot.child("oemail").getValue().toString());
